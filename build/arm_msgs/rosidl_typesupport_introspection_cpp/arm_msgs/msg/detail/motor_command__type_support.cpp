...
{
  new (message_memory) arm_msgs::msg::MotorCommand(_init);
}

void MotorCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<arm_msgs::msg::MotorCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorCommand_message_member_array[5] = {
  {
    ...
    offsetof(arm_msgs::msg::MotorCommand, q),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(arm_msgs::msg::MotorCommand, dq),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(arm_msgs::msg::MotorCommand, tau),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(arm_msgs::msg::MotorCommand, kp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(arm_msgs::msg::MotorCommand, kd),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorCommand_message_members = {
  ...
  5,  // number of fields
  sizeof(arm_msgs::msg::MotorCommand),
...
get_message_type_support_handle<arm_msgs::msg::MotorCommand>()
{
  return &::arm_msgs::msg::rosidl_typesupport_introspection_cpp::MotorCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arm_msgs, msg, MotorCommand)() {
  return &::arm_msgs::msg::rosidl_typesupport_introspection_cpp::MotorCommand_message_type_support_handle;
}
