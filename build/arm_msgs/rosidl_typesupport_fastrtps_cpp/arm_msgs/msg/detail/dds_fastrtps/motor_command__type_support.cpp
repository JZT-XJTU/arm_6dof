...
#include "arm_msgs/msg/detail/motor_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const arm_msgs::msg::MotorCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_msgs::msg::MotorCommand & ros_message)
{
  // Member: q
  cdr >> ros_message.q;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_msgs::msg::MotorCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_msgs::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_msgs::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  return &arm_msgs::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_msgs, msg, MotorCommand)() {
  return &arm_msgs::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
