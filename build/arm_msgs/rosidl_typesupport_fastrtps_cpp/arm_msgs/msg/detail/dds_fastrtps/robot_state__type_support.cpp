...
#include "arm_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const arm_msgs::msg::MotorState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  arm_msgs::msg::MotorState &);
...
cdr_serialize(
  const arm_msgs::msg::RobotState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_msgs::msg::RobotState & ros_message)
{
  // Member: motor_state
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        arm_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorState(
  ...
  if (is_plain) {
    ...
    using DataType = arm_msgs::msg::RobotState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &arm_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_msgs, msg, RobotState)() {
  return &arm_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
