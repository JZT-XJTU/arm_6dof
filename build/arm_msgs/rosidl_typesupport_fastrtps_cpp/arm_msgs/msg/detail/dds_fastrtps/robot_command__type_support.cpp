...
#include "arm_msgs/msg/detail/robot_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const arm_msgs::msg::MotorCommand &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  arm_msgs::msg::MotorCommand &);
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_command
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        arm_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorCommand(
  ...
  if (is_plain) {
    ...
    using DataType = arm_msgs::msg::RobotCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_msgs::msg::RobotCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_msgs::msg::RobotCommand *>(
    untyped_ros_message);
...
{
  return &arm_msgs::msg::typesupport_fastrtps_cpp::_RobotCommand__handle;
}
