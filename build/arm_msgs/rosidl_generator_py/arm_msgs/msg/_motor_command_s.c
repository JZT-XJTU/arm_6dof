...
bool arm_msgs__msg__motor_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arm_msgs.msg._motor_command.MotorCommand", full_classname_dest, 40) == 0);
  }
  arm_msgs__msg__MotorCommand * ros_message = _ros_message;
  {  // q
...
PyObject * arm_msgs__msg__motor_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("arm_msgs.msg._motor_command");
