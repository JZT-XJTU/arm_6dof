...
bool arm_msgs__msg__motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arm_msgs.msg._motor_state.MotorState", full_classname_dest, 36) == 0);
  }
  arm_msgs__msg__MotorState * ros_message = _ros_message;
  {  // q
...
PyObject * arm_msgs__msg__motor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("arm_msgs.msg._motor_state");
