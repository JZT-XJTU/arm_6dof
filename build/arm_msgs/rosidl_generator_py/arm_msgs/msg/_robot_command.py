...
class Metaclass_RobotCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from arm_msgs.msg import MotorCommand
...
class RobotCommand(metaclass=Metaclass_RobotCommand):
    ...
    _fields_and_field_types = {
        'motor_command': 'sequence<arm_msgs/MotorCommand>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['arm_msgs', 'msg'], 'MotorCommand')),  # noqa: E501
    )
