...
bool arm_msgs__msg__motor_mit_cmd_tau__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arm_msgs.msg._motor_mit_cmd_tau.MotorMitCmdTau", full_classname_dest, 46) == 0);
  }
  arm_msgs__msg__MotorMitCmdTau * ros_message = _ros_message;
  {  // tau
...
{
  /* NOTE(esteve): Call constructor of MotorMitCmdTau */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("arm_msgs.msg._motor_mit_cmd_tau");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotorMitCmdTau");
