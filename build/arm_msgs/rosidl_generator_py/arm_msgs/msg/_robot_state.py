...
class Metaclass_RobotState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from arm_msgs.msg import MotorState
...
class RobotState(metaclass=Metaclass_RobotState):
    ...
    _fields_and_field_types = {
        'motor_state': 'sequence<arm_msgs/MotorState>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['arm_msgs', 'msg'], 'MotorState')),  # noqa: E501
    )
